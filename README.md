...
For development purposes and to easily share the Keycloak configuration between developers, it may be smart to include the realm configuration in your repository.
